...
strip -s -R .comment -R .gnu.version --strip-unneeded --keep-symbol=CreatePdbSymbolReader --keep-symbol=DeletePdbSymbolReader --keep-symbol=FindLineNumberForManagedMethod --keep-symbol=FindLineNumberForNativeMethod --keep-symbol=FindNameForRVA --keep-symbol=GetPdbAndSignatureAndAge --keep-symbol=GetSourceLinkData --keep-symbol=GetSrcSrvData --keep-symbol=IsReaderValid $Output